...
const AdminSidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView }) => {
  return (
      ...
      <div className="p-4">
        <nav className="space-y-2">
          ...
          <div className="pt-4 border-t border-gray-200">
            <button className="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-50 w-full text-left transition-colors">
