...
const PackageDocumentModal2: React.FC<PackageDocumentModalProps> = ({
  ...
  // ---- Range: 11 lakh to 50 lakh ----
  const minAmount = 1_100_000;
  ...
  const PURPOSES: Record<Category, { id: string; label: string }[]> = {
    "MBBS/BDS": [
      ...
      { id: "mbbs_const", label: "Construction of hospitals" },
    ],
    Pharmacist: [
    ...
    "Blood Bank/Laboratories": [
      { id: "lab_eqp", label: "Purchase medical equipment" },
      { id: "lab_reno", label: "Renovation of clinic/building" },
      { id: "lab_furn", label: "Purchase of furniture and fixture" },
      { id: "lab_elec", label: "Purchase of electronic items" },
      { id: "lab_const", label: "Construction of hospitals" },
    ],
  };
  ...
  const getDefaultCategory = (profession: string): Category => {
    ...
    if (lowerProfession.includes('lab') || lowerProfession.includes('laboratory') || 
        lowerProfession.includes('blood bank') || lowerProfession.includes('technician')) {
      return "Blood Bank/Laboratories";
    }
    // Default fallback
    return "MBBS/BDS";
  };
  ...
  const getAvailableCategories = (profession: string): Category[] => {
    ...
    return ["MBBS/BDS", "Pharmacist", "Blood Bank/Laboratories"];
  };
  ...
  const [availableCategories, setAvailableCategories] = useState<Category[]>(["MBBS/BDS", "Pharmacist", "Blood Bank/Laboratories"]);
  ...
  const handleContinue = async () => {
    try {
      ...
      // Small delay to ensure data is saved and show loader
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      router.push("/feechalan2");
    } catch (error) {
  ...
  const updatedScheme = {
    ...scheme,
    description:
      "For MBBS, BDS, Pharmacist, Laboratories, Blood Bank.",
  };
          ...
          {activeTab === "Purpose" && (
            <div className="h-full flex flex-col">
              ...
              {availableCategories.length > 1 && (
                <div className="flex items-center gap-3 sm:gap-4 py-2 flex-wrap">
              ...
              <div role="radiogroup" className="mt-3">
            ...
            <div className="grid md:grid-cols-2 gap-6 md:gap-8">
              <div>
                ...
                <input
                  ...
                  placeholder="Enter amount (e.g., 1,500,000)"
                />
                {amountError && (
              ...
              <div>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    className={`px-6 sm:px-8 py-3 rounded-xl font-semibold transition-all text-base sm:text-lg shadow-lg hover:shadow-xl flex items-center gap-2 ${
                      isNavigating 
